...
export default function SignInPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[radial-gradient(circle_at_top,#13294b_0%,#0a192f_45%,#050b16_100%)] pt-24 pb-16 px-4 select-none">
      {/* Banner Superior de WeShuttle */}
      <div className="flex flex-col items-center mb-8 text-center">
        <div className="flex items-center justify-center w-14 h-14 bg-white rounded-xl border border-slate-200 shadow-[0_4px_16px_rgba(0,0,0,0.1)] p-3 mb-3 shrink-0 transition-transform duration-300 hover:scale-105">
      ...
      <SignIn
        ...
        appearance={{
          elements: {
            ...
            card: "bg-white rounded-[8px] border border-slate-200 shadow-xl",
            ...
            formFieldInput: "rounded-[8px] border border-slate-200 focus:border-[#0a192f] focus:ring-1 focus:ring-[#0a192f] focus:outline-none transition-all h-10",
            footerActionLink: "text-[#0a192f] hover:text-[#13294b] transition-colors font-bold",
            formFieldAction: "text-[#0a192f] hover:text-[#13294b] transition-colors font-bold",
